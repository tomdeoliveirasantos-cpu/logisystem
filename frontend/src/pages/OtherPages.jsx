...
export function Manutencoes() {
  ...
  const cols=[{k:'data_manutencao',l:'Data',f:v=>fmtDate(v)},{k:'placa',l:'Placa'},{k:'modelo',l:'Modelo'},{k:'tipo_manutencao',l:'Tipo'},{k:'componente',l:'Componente'},{k:'descricao',l:'Descrição'},{k:'valor_orcamento',l:'Valor (R$)',f:v=>v?Number(v).toFixed(2):''},{k:'data_vencimento',l:'Vencimento',f:v=>fmtDate(v)},{k:'aprovado_por',l:'Aprovado por'}];
  return (
    <div>
